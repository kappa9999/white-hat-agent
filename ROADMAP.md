...
- expand typed operations beyond the current Ghidra summary/native-code map, YARA-X file signature evaluation, capa
  analysis, LLVM object inspection, and JADX Android static map;
